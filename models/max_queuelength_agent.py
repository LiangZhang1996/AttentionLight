"""
Max-Queue agent.
observation: [lane_queue_vehicle_in].
...
class MaxQLAgent(Agent):

    def __init__(self, dic_agent_conf, dic_traffic_env_conf, dic_path, cnt_round, intersection_id):

        super(MaxQLAgent, self).__init__(dic_agent_conf, dic_traffic_env_conf, dic_path, intersection_id)
    ...
    def choose_action(self, count, state):
        ...
        #  WT_ET
        tr_mo_pr = np.array(state["lane_queue_vehicle_in"])
