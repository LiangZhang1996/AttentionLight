...
class Intersection:
    ...
    def _update_feature(self):
        ...
        dic_feature["lane_num_vehicle_in"] = self._get_lane_num_vehicle(self.list_entering_lanes)
        dic_feature["lane_num_vehicle_out"] = self._get_lane_num_vehicle(self.list_exiting_lanes)
